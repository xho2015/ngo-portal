...
var AppMainUI = (function() {	
	...
	function initPanel() {
		...
		var spriteBMP = new createjs.Shape(); //new createjs.Bitmap("/app/res/tile.png");
		spriteBMP.graphics.beginFill("#004").drawRect(5, 0, 110, 80);
		spriteBMP.y = 4;
		spriteBMP.x = 0;
		var spriteBMP2 = new createjs.Shape(); //new createjs.Bitmap("/app/res/tile.png");
		spriteBMP2.graphics.beginFill("#004").drawRect(5, 0, 110, 80);
		spriteBMP2.y = 88;
		spriteBMP2.x = 0;
		var spriteBMP3 = new createjs.Shape(); //new createjs.Bitmap("/app/res/tile.png");
		...
		moduleNPCs.push( spriteBMP, spriteBMP2,	spriteBMP3, squareUp, squareDown);
		...
		var moduleRect = new createjs.Rectangle(moduleContainer.x, moduleContainer.y, moduleContainer.width, moduleContainer.height);
